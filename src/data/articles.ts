...
export const articles: Article[] = [
  {
    ...
    thumbnailUrl: '/placeholder-article-1.jpg',
    order: 1
  },
  {
    slug: 'google-keyword-planner-guide',
    title: 'Google Keyword Planner: Measuring Real Search Demand with Data',
    subtitle: 'Master the art of keyword research using Google\'s official tool to find high-value search terms for your business.',
    ...
    readingTime: 10,
    category: 'Google Tools',
    thumbnailUrl: '/placeholder-article-2.jpg',
    order: 2
  },
  {
    slug: 'google-ads-guide',
    title: 'Google Ads: Turning Keywords into Clicks and Conversions',
    subtitle: 'Transform your keyword research into profitable advertising campaigns that drive real business results.',
