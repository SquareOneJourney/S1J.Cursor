...
export const tiles: Tile[] = [
  ...
  // Start Journey Tiles
  {
    id: 'start-business-ideas',
    title: 'Generate Business Ideas with AI',
    description: 'Use AI to analyze market trends and generate personalized business ideas based on your skills and location.',
    level: 1,
    journeyType: 'start',
    content: {
      type: 'interactive',
    ...
    links: [
      {
        ...
        description: 'Tools for analyzing market opportunities',
        type: 'tool'
      },
      {
    ...
    tags: ['business ideas', 'market research', 'planning'],
    estimatedTime: '25 minutes',
    difficulty: 'beginner'
  },
  {
    ...
    description: 'Create your brand identity, logo, and marketing materials using AI design tools.',
    level: 2,
    journeyType: 'start',
    content: {
      type: 'video',
      data: {
        title: 'Brand Creation Walkthrough',
        duration: '12 minutes'
      }
    },
    links: [
      ...
      {
        name: 'Logo Maker',
        url: 'https://example.com/logo-maker',
        description: 'AI logo generation tool',
        type: 'tool'
      }
    ],
  ...
  {
    id: 'start-marketing-setup',
    title: 'Marketing Automation Setup',
    description: 'Set up automated marketing campaigns and social media management using AI tools.',
    level: 3,
    journeyType: 'start',
    content: {
      type: 'text',
      data: {
        text: 'Marketing automation can help you reach customers consistently without spending hours each day. This guide covers setting up email campaigns, social media scheduling, and lead nurturing systems using AI-powered tools.'
      }
    },
    links: [
      {
  ...
  // Integrate Journey Tiles
  {
    id: 'integrate-workflow-automation',
    title: 'Workflow Automation',
    description: 'Identify and automate repetitive tasks in your existing business processes.',
    level: 1,
    ...
    links: [
      ...
      },
      {
        ...
        url: 'https://example.com/process-mapping',
        description: 'Guide to mapping business processes',
        type: 'guide'
      }
    ],
  ...
  {
    id: 'integrate-data-analysis',
    title: 'AI Data Analysis',
    description: 'Use AI to analyze your business data and gain insights for better decision making.',
    level: 2,
    journeyType: 'integrate',
    content: {
      type: 'video',
  ...
  {
    id: 'integrate-inventory-management',
    title: 'Smart Inventory Management',
    description: 'Implement AI-powered inventory tracking and demand forecasting for your business.',
    level: 3,
    journeyType: 'integrate',
    content: {
      type: 'text',
      data: {
        text: 'Smart inventory management uses AI to predict demand, optimize stock levels, and reduce waste. This advanced guide covers implementing predictive analytics, automated reordering, and demand forecasting systems.'
      }
    },
    links: [
      {
        name: 'TradeGecko',
        url: 'https://tradegecko.com',
        description: 'Inventory management with AI',
        type: 'tool'
      },
      {
        name: 'Demand Forecasting Guide',
        url: 'https://example.com/forecasting',
        description: 'Guide to demand prediction',
        type: 'guide'
      }
    ],
...
export const tileCategories: TileCategory[] = [
  ...
  },
  {
    ...
    description: 'Build the foundation of your new business with AI-powered tools.',
    tiles: tiles.filter(t => t.journeyType === 'start' && t.level <= 2),
    level: 1,
    journeyType: 'start'
  },
  {
    ...
    description: 'Scale your business with AI-driven marketing and growth strategies.',
    tiles: tiles.filter(t => t.journeyType === 'start' && t.level > 2),
    level: 2,
    journeyType: 'start'
  },
  {
    id: 'integrate-automation',
    name: 'Process Automation',
    description: 'Streamline your existing operations with AI automation.',
    tiles: tiles.filter(t => t.journeyType === 'integrate' && t.level <= 2),
    level: 1,
    journeyType: 'integrate'
  },
  {
    id: 'integrate-optimization',
    name: 'Advanced Optimization',
    description: 'Optimize your business with advanced AI analytics and forecasting.',
    tiles: tiles.filter(t => t.journeyType === 'integrate' && t.level > 2),
    level: 2,
    journeyType: 'integrate'
  }
