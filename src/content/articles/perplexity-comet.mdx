...
It doesn’t just show you pages; it reads them, summarizes them, and helps you act on what matters.
...
- **Summarize any page:** `⌘/Ctrl + J` → “Summarize this page for key points and next steps.”  
